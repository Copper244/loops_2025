...
# numbers from **1 to 10**, each on a new line.
...
# then calculate and display the **sum of all numbers from 1 to n**.
...
# Ask the user for a number **n**,
#  then print the first **n numbers** of the Fibonacci sequence.
